...
#define PCRIT_Enable          1                                         /* 使能重复中断定时器		    */                                                                       /* 功率/时钟控制位              */
#define PCRIT_Disable         0                                         /* 禁止重复中断定时器           */                                                                        /* 功率/时钟控制位	            */
#define PCRIT_FUNC            PCRIT_Enable

#define PCMC_Enable           1                                         /* 使能电机控制PWM              */
#define PCMC_Disable          0                                         /* 禁止电机控制PWM              */
#define PCMC_FUNC             PCMC_Disable

#define PCQEI_Enable          1                                         /* 使能正交编码器接口           */                                                                        /* 功率/时钟控制位              */
#define PCQEI_Disable         0                                         /* 禁止正交编码器接口           */                                                                        /* 功率/时钟控制位              */
...
#define PCGPDMA_FUNC          PCGPDMA_Enable
